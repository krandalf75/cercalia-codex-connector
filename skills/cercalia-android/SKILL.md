---
name: cercalia-android-routing-geocoding
description: Build and maintain Android applications using Cercalia APIs for maps, routing, POI, and geospatial workflows.
---

# Cercalia Android Skill

Use this skill when developing applications that consume Cercalia services.

## Trigger Keywords

cercalia, android, kotlin, java, gradle, jetpack compose, retrofit, okhttp, maps sdk, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry
...
```bash
# Follow the official Android SDK guide.
# Add Gradle/Maven coordinates once confirmed by Cercalia docs/support.
```

## References

- Android SDK docs: https://docs.cercalia.com/docs/sdks/client-side/android/
