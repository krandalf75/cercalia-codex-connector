---
name: cercalia-dotnet-routing-geocoding
description: Build and maintain .NET applications using Cercalia APIs for geocoding, routing, POI, and geospatial workflows.
---
...
cercalia, dotnet, .net, c#, nuget, asp.net core, minimal api, httpclient, rest client, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
```bash
# Generate or hand-write a REST client from Cercalia OpenAPI/Core REST docs
# until an official NuGet package is published.
```

## References

- Official SDK overview: https://docs.cercalia.com/docs/
- Core REST API docs: https://docs.cercalia.com/docs/core-rest-api/
