---
name: cercalia-go-routing-geocoding
description: Build and maintain Go applications using Cercalia APIs for geocoding, routing, POI, isochrones, and geospatial workflows.
---
...
cercalia, go, golang, go modules, gin, fiber, chi, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
- Official SDK docs: https://docs.cercalia.com/docs/sdks/server-side/go/
- Source repository: https://github.com/Cercalia/cercalia-sdk-go
- Go package docs: https://pkg.go.dev/github.com/cercalia/cercalia-sdk-go
