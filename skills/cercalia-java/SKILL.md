---
name: cercalia-java-routing-geocoding
description: Build and maintain Java applications using Cercalia APIs for geocoding, routing, POI, isochrones, and geospatial workflows.
---
...
cercalia, java, maven, gradle, spring boot, quarkus, micronaut, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
- Official SDK docs: https://docs.cercalia.com/docs/sdks/server-side/java/
- Source repository: https://github.com/Cercalia/cercalia-sdk-java
- SDK reference docs: https://docs.cercalia.com/docs/sdks/reference/java/
