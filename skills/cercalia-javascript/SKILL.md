---
name: cercalia-javascript-routing-geocoding
description: Build and maintain JavaScript applications using Cercalia APIs for maps, geocoding, routing, POI, and geospatial workflows.
---

# Cercalia JavaScript Skill

Use this skill when developing applications that consume Cercalia services.

## Trigger Keywords

cercalia, javascript, node.js, npm, yarn, pnpm, express, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
