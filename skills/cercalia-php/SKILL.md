---
name: cercalia-php-routing-geocoding
description: Build and maintain PHP applications using Cercalia APIs for geocoding, routing, POI, and geospatial workflows.
---
...
cercalia, php, composer, packagist, laravel, symfony, guzzle, rest client, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
```bash
# Create a Composer package around Cercalia REST/OpenAPI endpoints
# until an official Packagist package is published.
```
