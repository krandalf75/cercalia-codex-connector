---
name: cercalia-python-routing-geocoding
description: Build and maintain Python applications using Cercalia APIs for geocoding, routing, POI, isochrones, and geospatial workflows.
---

# Cercalia Python Skill

Use this skill when developing applications that consume Cercalia services.

## Trigger Keywords

cercalia, python, pip, pypi, fastapi, flask, django, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
- Official SDK docs: https://docs.cercalia.com/docs/sdks/server-side/python/
- Source repository: https://github.com/Cercalia/cercalia-sdk-python
- PyPI package: https://pypi.org/project/cercalia-sdk/
