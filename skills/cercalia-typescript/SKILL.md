---
name: cercalia-typescript-routing-geocoding
description: Build and maintain TypeScript applications using Cercalia APIs for geocoding, routing, POI, isochrones, and geospatial workflows.
---

# Cercalia TypeScript Skill

Use this skill when developing applications that consume Cercalia services.

## Trigger Keywords

cercalia, typescript, node.js, npm, yarn, pnpm, nestjs, express, ts-node, geospatial, gis, geocoding, reverse geocoding, routing, route optimization, matrix, eta, isochrone, poi, proximity, geofence, point in polygon, snap to road, static map, wms, geometry, openapi
...
# or: yarn add cercalia-sdk-ts
# or: pnpm add cercalia-sdk-ts
```

## References

- Official SDK docs: https://docs.cercalia.com/docs/sdks/server-side/typescript/
- Source repository: https://github.com/Cercalia/cercalia-sdk-ts
- npm package: https://www.npmjs.com/package/cercalia-sdk-ts
- SDK reference docs: https://docs.cercalia.com/docs/sdks/reference/typescript/
